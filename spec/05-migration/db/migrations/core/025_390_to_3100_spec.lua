...
describe("database migration", function()
  uh.old_after_up("has \"clustering_sync_delta\" table", function()
  ...
  uh.old_after_up("clustering_sync_delta has version as bigint", function()
    assert.table_has_column("clustering_sync_delta", "version", "bigint")
  end)
end)
